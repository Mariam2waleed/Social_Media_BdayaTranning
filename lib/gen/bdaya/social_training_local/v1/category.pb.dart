...
class CategoryDto extends $pb.GeneratedMessage {
  ...
  CategoryDto._() : super();
  factory CategoryDto.fromBuffer(
...
class TestOptions extends $pb.GeneratedMessage {
  ...
  TestOptions._() : super();
  factory TestOptions.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory TestOptions.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$1.SortDirection>(
      1,
      _omitFieldNames ? '' : 'currentSortDirection',
      $pb.PbFieldType.OE,
      defaultOrMaker: $1.SortDirection.SORT_DIRECTION_UNSPECIFIED,
      valueOf: $1.SortDirection.valueOf,
      enumValues: $1.SortDirection.values,
    )
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TestOptions copyWith(void Function(TestOptions) updates) =>
      super.copyWith((message) => updates(message as TestOptions))
          as TestOptions;
  ...
  @$core.pragma('dart2js:noInline')
  static TestOptions getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TestOptions>(create);
  static TestOptions? _defaultInstance;

  @$pb.TagNumber(1)
  $1.SortDirection get currentSortDirection => $_getN(0);
  @$pb.TagNumber(1)
  set currentSortDirection($1.SortDirection v) {
    setField(1, v);
  }
