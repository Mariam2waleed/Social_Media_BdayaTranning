...
import 'package:social_media/gen/bdaya/social_training/v1/common.pb.dart' as $5;
import 'package:social_media/gen/bdaya/social_training/v1/common.pbenum.dart'
    as $5;
import 'package:social_media/gen/bdaya/social_training/v1/post.pb.dart' as $6;
import 'package:social_media/gen/bdaya/social_training/v1/post.pbenum.dart'
    as $6;
import 'package:social_media/gen/google/protobuf/wrappers.pb.dart' as $7;
...
class ListPostsRequest extends $pb.GeneratedMessage {
  ...
  factory ListPostsRequest.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory ListPostsRequest.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$5.InfiniteScrollPaginationInfo>(
      1,
      _omitFieldNames ? '' : 'pagination',
      subBuilder: $5.InfiniteScrollPaginationInfo.create,
    )
    ..aOM<ListPostsFilter>(
      2,
      _omitFieldNames ? '' : 'filter',
      subBuilder: ListPostsFilter.create,
    )
    ..aOM<ListPostsSorting>(
      3,
      _omitFieldNames ? '' : 'sort',
      subBuilder: ListPostsSorting.create,
    )
  ...
  static $pb.PbList<ListPostsRequest> createRepeated() =>
      $pb.PbList<ListPostsRequest>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set pagination($5.InfiniteScrollPaginationInfo v) {
    setField(1, v);
  }
...
class ListPostsFilter extends $pb.GeneratedMessage {
  ...
  factory ListPostsFilter.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory ListPostsFilter.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    _omitMessageNames ? '' : 'ListPostsFilter',
    package: const $pb.PackageName(
      _omitMessageNames ? '' : 'bdaya.social_training.v1',
    ),
    createEmptyInstance: create,
    ...
    ..aOM<$5.DateFilter>(
      2,
      _omitFieldNames ? '' : 'creationTime',
      subBuilder: $5.DateFilter.create,
    )
    ..e<$6.PostReviewStatus>(
      3,
      _omitFieldNames ? '' : 'reviewStatus',
      $pb.PbFieldType.OE,
      defaultOrMaker: $6.PostReviewStatus.POST_REVIEW_STATUS_UNSPECIFIED,
      valueOf: $6.PostReviewStatus.valueOf,
      enumValues: $6.PostReviewStatus.values,
    )
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ListPostsFilter copyWith(void Function(ListPostsFilter) updates) =>
      super.copyWith((message) => updates(message as ListPostsFilter))
          as ListPostsFilter;
  ...
  static $pb.PbList<ListPostsFilter> createRepeated() =>
      $pb.PbList<ListPostsFilter>();
  @$core.pragma('dart2js:noInline')
  static ListPostsFilter getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ListPostsFilter>(create);
  ...
  @$pb.TagNumber(2)
  set creationTime($5.DateFilter v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set reviewStatus($6.PostReviewStatus v) {
    setField(3, v);
  }
...
enum ListPostsSorting_SortProperty { creationTime, latestCommentTime, notSet }
...
class ListPostsSorting extends $pb.GeneratedMessage {
  ...
  factory ListPostsSorting.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory ListPostsSorting.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, ListPostsSorting_SortProperty>
      _ListPostsSorting_SortPropertyByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    _omitMessageNames ? '' : 'ListPostsSorting',
    package: const $pb.PackageName(
      _omitMessageNames ? '' : 'bdaya.social_training.v1',
    ),
    createEmptyInstance: create,
    ...
    ..e<$5.SortDirection>(
      ...
      _omitFieldNames ? '' : 'creationTime',
      $pb.PbFieldType.OE,
      defaultOrMaker: $5.SortDirection.SORT_DIRECTION_UNSPECIFIED,
      valueOf: $5.SortDirection.valueOf,
      enumValues: $5.SortDirection.values,
    )
    ..e<$5.SortDirection>(
      2,
      _omitFieldNames ? '' : 'latestCommentTime',
      $pb.PbFieldType.OE,
      defaultOrMaker: $5.SortDirection.SORT_DIRECTION_UNSPECIFIED,
      valueOf: $5.SortDirection.valueOf,
      enumValues: $5.SortDirection.values,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ListPostsSorting copyWith(void Function(ListPostsSorting) updates) =>
      super.copyWith((message) => updates(message as ListPostsSorting))
          as ListPostsSorting;
  ...
  static $pb.PbList<ListPostsSorting> createRepeated() =>
      $pb.PbList<ListPostsSorting>();
  @$core.pragma('dart2js:noInline')
  static ListPostsSorting getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ListPostsSorting>(create);
  static ListPostsSorting? _defaultInstance;

  ListPostsSorting_SortProperty whichSortProperty() =>
      _ListPostsSorting_SortPropertyByTag[$_whichOneof(0)]!;
  void clearSortProperty() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  $5.SortDirection get creationTime => $_getN(0);
  @$pb.TagNumber(1)
  set creationTime($5.SortDirection v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set latestCommentTime($5.SortDirection v) {
    setField(2, v);
  }
...
class ListPostsResponse extends $pb.GeneratedMessage {
  ...
  factory ListPostsResponse.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory ListPostsResponse.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$6.Post>(
      1,
      _omitFieldNames ? '' : 'posts',
      $pb.PbFieldType.PM,
      subBuilder: $6.Post.create,
    )
    ..aOM<$7.StringValue>(
      2,
      _omitFieldNames ? '' : 'nextPageToken',
  ...
  static $pb.PbList<ListPostsResponse> createRepeated() =>
      $pb.PbList<ListPostsResponse>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set nextPageToken($7.StringValue v) {
    setField(2, v);
  }
...
class GetPostRequest extends $pb.GeneratedMessage {
  ...
  factory GetPostRequest.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory GetPostRequest.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
...
class GetPostResponse extends $pb.GeneratedMessage {
  ...
  factory GetPostResponse.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory GetPostResponse.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<GetPostResponse> createRepeated() =>
      $pb.PbList<GetPostResponse>();
  @$core.pragma('dart2js:noInline')
...
class CreatePostRequest extends $pb.GeneratedMessage {
  ...
  factory CreatePostRequest.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory CreatePostRequest.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
...
class CreatePostResponse extends $pb.GeneratedMessage {
  ...
  factory CreatePostResponse.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory CreatePostResponse.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<CreatePostResponse> createRepeated() =>
      $pb.PbList<CreatePostResponse>();
  @$core.pragma('dart2js:noInline')
...
class UpdatePostRequest extends $pb.GeneratedMessage {
  ...
  factory UpdatePostRequest.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory UpdatePostRequest.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<UpdatePostRequest> createRepeated() =>
      $pb.PbList<UpdatePostRequest>();
  @$core.pragma('dart2js:noInline')
...
class UpdatePostResponse extends $pb.GeneratedMessage {
  ...
  factory UpdatePostResponse.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory UpdatePostResponse.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<UpdatePostResponse> createRepeated() =>
      $pb.PbList<UpdatePostResponse>();
  @$core.pragma('dart2js:noInline')
...
class DeletePostRequest extends $pb.GeneratedMessage {
  ...
  factory DeletePostRequest.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory DeletePostRequest.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
...
class DeletePostResponse extends $pb.GeneratedMessage {
  ...
  factory DeletePostResponse.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
  factory DeletePostResponse.fromJson(
    $core.String i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromJson(i, r);
